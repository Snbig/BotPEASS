...
def send_telegram_message(message: str, public_expls_msg: str):
    ...
    r = requests.get(f'https://api.telegram.org/bot{telegram_bot_token}/sendMessage?parse_mode=HTML&text=<a>as##das__dasdasd</a>&chat_id={telegram_chat_id}&message_thread_id={telegram_thread_id}')
